...
public class ShapeOfView extends FrameLayout {
    ...
    private RoundRectView.ClipManager clipManager = new RoundRectView.ClipPathManager();
    ...
    public void setClipPathCreator(RoundRectView.ClipPathManager.ClipPathCreator createClipPath) {
        ((RoundRectView.ClipPathManager) clipManager).setClipPathCreator(createClipPath);
        requiresShapeUpdate();
    }
